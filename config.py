...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = int(os.environ.get("TECH_VJ_BOT_TOKEN", "5368562765:AAF3X_Zlk9DGsHszQd97-xQHYu4MBk5QzkY"))
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "miircytbot") # Bot username without @.

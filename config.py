...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = int(os.environ.get("TECH_VJ_BOT_TOKEN", "7687605001:AAFhJ4-CR2cYvFSsBMeyWvm8C78kZfp9NjY"))
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "mohanurlbot") # Bot username without @.
    
    # The Telegram API things
    TECH_VJ_API_ID = os.environ.get("TECH_VJ_API_ID", "12655645")
    TECH_VJ_API_HASH = os.environ.get("TECH_VJ_API_HASH", "05c4cafe00b81ed83207bb4365e0053b")
    ...
    TECH_VJ_OWNER_ID = int(os.environ.get("TECH_VJ_OWNER_ID", "1025922801")) 
    TECH_VJ_SESSION_NAME = "VJ-URL-UPLOADER-BOT"
    
    # database uri (mongodb)
    TECH_VJ_DATABASE_URL = os.environ.get("TECH_VJ_DATABASE_URL", "mongodb+srv://mohan:dNR0tiLpnTuTbiFu@cluster0.fhcly.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
    TECH_VJ_MAX_RESULTS = "50"

    # channel information
    TECH_VJ_LOG_CHANNEL = int(os.environ.get("TECH_VJ_LOG_CHANNEL", "-1001612018544")) # your log channel id and make bot admin in log channel with full right 
